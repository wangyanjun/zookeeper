...
// Type: Org.Apache.Zookeeper.Proto.SetSASLRequest
...
namespace Org.Apache.Zookeeper.Proto
{
    public class SetSASLRequest : IRecord, IComparable
    {
        ...
        public override string ToString()
        {
            ...
            {
                SetSASLRequest.log.Error((object)ex);
            }
            return "ERROR";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            if (setSaslRequest == null)
                return false;
            if (object.ReferenceEquals((object)setSaslRequest, (object)this))
                return true;
            bool flag = this.Token.Equals((object)setSaslRequest.Token);
            if (!flag)
                return flag;
            return flag;
        }
