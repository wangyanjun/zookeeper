...
// Type: Org.Apache.Zookeeper.Proto.SetDataResponse
...
namespace Org.Apache.Zookeeper.Proto
{
    public class SetDataResponse : IRecord, IComparable
    {
        ...
        public override string ToString()
        {
            ...
            {
                SetDataResponse.log.Error((object)ex);
            }
            return "ERROR";
        }
        ...
        public int CompareTo(object obj)
        {
            ...
            int num = this.Stat.CompareTo((object)setDataResponse.Stat);
            if (num != 0)
                return num;
            return num;
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            if (setDataResponse == null)
                return false;
            if (object.ReferenceEquals((object)setDataResponse, (object)this))
                return true;
            bool flag = this.Stat.Equals((object)setDataResponse.Stat);
            if (!flag)
                return flag;
            return flag;
        }
