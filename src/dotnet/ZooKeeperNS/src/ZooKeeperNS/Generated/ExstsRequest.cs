...
// Type: Org.Apache.Zookeeper.Proto.ExistsRequest
...
namespace Org.Apache.Zookeeper.Proto
{
    public class ExistsRequest : IRecord, IComparable
    {
        ...
        public override string ToString()
        {
            ...
            {
                ExistsRequest.log.Error((object)ex);
            }
            return "ERROR";
        }
        ...
        public int CompareTo(object obj)
        {
            ...
            int num1 = this.Path.CompareTo(existsRequest.Path);
            if (num1 != 0)
                return num1;
            int num2 = this.Watch == existsRequest.Watch ? 0 : (this.Watch ? 1 : -1);
            if (num2 != 0)
                return num2;
            return num2;
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            if (existsRequest == null)
                return false;
            if (object.ReferenceEquals((object)existsRequest, (object)this))
                return true;
            bool flag1 = this.Path.Equals(existsRequest.Path);
            if (!flag1)
                return flag1;
            bool flag2 = this.Watch == existsRequest.Watch;
            if (!flag2)
                return flag2;
            return flag2;
        }
