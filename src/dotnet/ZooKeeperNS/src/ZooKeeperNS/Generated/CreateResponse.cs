...
// Type: Org.Apache.Zookeeper.Proto.CreateResponse
...
namespace Org.Apache.Zookeeper.Proto
{
    public class CreateResponse : IRecord, IComparable
    {
        ...
        public override string ToString()
        {
            ...
            {
                CreateResponse.log.Error((object)ex);
            }
            return "ERROR";
        }
        ...
        public int CompareTo(object obj)
        {
            ...
            int num = this.Path.CompareTo(createResponse.Path);
            if (num != 0)
                return num;
            return num;
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            if (createResponse == null)
                return false;
            if (object.ReferenceEquals((object)createResponse, (object)this))
                return true;
            bool flag = this.Path.Equals(createResponse.Path);
            if (!flag)
                return flag;
            return flag;
        }
