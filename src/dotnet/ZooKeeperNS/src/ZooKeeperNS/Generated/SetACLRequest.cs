...
// Type: Org.Apache.Zookeeper.Proto.SetACLRequest
    ...
    public class SetACLRequest : IRecord, IComparable
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            if (setAclRequest == null)
                return false;
            if (object.ReferenceEquals((object)setAclRequest, (object)this))
                return true;
            bool flag1 = this.Path.Equals(setAclRequest.Path);
            if (!flag1)
                return flag1;
            bool flag2 = this.Acl.Equals((object)setAclRequest.Acl);
            if (!flag2)
                return flag2;
            bool flag3 = this.Version == setAclRequest.Version;
            if (!flag3)
                return flag3;
            return flag3;
        }
